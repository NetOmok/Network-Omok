...
public class OmokClient extends JFrame implements Runnable, ActionListener {
	...
	public OmokClient(String title){ // 생성자
		...
		makeRoom.setBounds(700, 205, 130, 44); //enterButton2.setBounds(1000, 128, 233, 120);
		...
		makeRoom.addMouseListener(new MouseAdapter(){
			...
			public void mouseClicked(MouseEvent arg0){
				try{
					...
					f1.getContentPane().add(enterButton);
					f1.getContentPane().add(roomName);
					f1.getContentPane().add(roomPassword);
